...
-- Dumping structure for table ticketdemo.agent_locations
...
-- Dumping structure for table ticketdemo.user_settings
...
CREATE TABLE IF NOT EXISTS `vouchers` (
  ...
  `has_one_code` tinyint(1) NOT NULL DEFAULT '0',
  `one_code_quota` int(11) DEFAULT '0',
  `redemption_code` varchar(20) DEFAULT NULL,
  `redemption_method` enum('none','password','qrcode','qrcode_password') DEFAULT 'none',
  `template_path` varchar(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `voucher_codes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37561 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `voucher_code_configs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4137 DEFAULT CHARSET=utf8mb4;
...
-- Dumping structure for table ticketdemo.voucher_redemption_locations
