...
CREATE TABLE IF NOT EXISTS `abilities` (
  ...
  `only_owned` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
-- Dumping structure for table evoucher.agent_locations
...
-- Dumping structure for table evoucher.agent_smtp_servers
...
-- Dumping structure for table evoucher.commands
...
-- Dumping structure for table evoucher.input_obj_attributes
...
-- Dumping structure for table evoucher.input_obj_groups
...
-- Dumping structure for table evoucher.input_obj_group_attributes
...
-- Dumping structure for table evoucher.input_obj_types
...
-- Dumping structure for table evoucher.jobs
...
-- Dumping structure for table evoucher.questionnaire_participants
...
-- Dumping structure for table evoucher.questionnaire_participantsxxxxx
CREATE TABLE IF NOT EXISTS `questionnaire_participantsxxxxx` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `voucher_template_id` int(10) unsigned NOT NULL DEFAULT '0',
  `field_values` text,
  `created_at` timestamp NULL DEFAULT NULL,
...
-- Dumping structure for table evoucher.smtp_servers
...
-- Dumping structure for table evoucher.temp_question_forms
...
-- Dumping structure for table evoucher.temp_upload_files
...
-- Dumping structure for table evoucher.user_settings
CREATE TABLE IF NOT EXISTS `user_settings` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `key_name` varchar(50) NOT NULL DEFAULT '',
  `key_value` varchar(191) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `vouchers` (
  ...
  `templatexxxx` mediumtext,
  `voucher_type` enum('form','voucher') DEFAULT 'voucher',
  `has_one_code` tinyint(1) unsigned DEFAULT '0',
  `one_code_quota` int(11) DEFAULT '0',
  `redemption_code` varchar(20) DEFAULT NULL,
  `redemption_method` enum('none','password','qrcode','qrcode_password') NOT NULL DEFAULT 'none',
  `template_path` varchar(10) DEFAULT NULL,
  ...
  `action_type_before_goal` varchar(50) DEFAULT NULL,
  `custom_form_key_before_goal` varchar(50) DEFAULT '',
  `action_type_after_goal` varchar(50) DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2051 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `voucher_codes` (
  ...
  `redemption_location_id` int(10) unsigned DEFAULT '0',
  `views` int(10) unsigned DEFAULT '0',
  `status` enum('hold','pending','processing','completed','fails') DEFAULT 'pending',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35809 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `voucher_code_configs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4093 DEFAULT CHARSET=utf8mb4;

-- Data exporting was unselected.

-- Dumping structure for table evoucher.voucher_custom_forms
...
-- Dumping structure for table evoucher.voucher_mailing_status
...
-- Dumping structure for table evoucher.voucher_medias
...
-- Dumping structure for table evoucher.voucher_participants
CREATE TABLE IF NOT EXISTS `voucher_participants` (
  ...
  `remark` text,
  `status` enum('processing','pending','hold','completed','fails') DEFAULT 'pending',
  `error_message` varchar(191) DEFAULT '',
  `sent_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping structure for table evoucher.voucher_redemption_locations
CREATE TABLE IF NOT EXISTS `voucher_redemption_locations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `voucher_id` int(10) unsigned NOT NULL DEFAULT '0',
  `order` int(10) unsigned NOT NULL DEFAULT '0',
...
-- Dumping structure for table evoucher.voucher_smtp_servers
...
-- Dumping structure for table evoucher.voucher_templates
