...
-- Dumping structure for table coupon_yoov_com.commands
...
-- Dumping structure for table coupon_yoov_com.jobs
...
-- Dumping structure for table coupon_yoov_com.questionnaire_participantsxxxxx
...
-- Dumping structure for table coupon_yoov_com.smtp_servers
...
CREATE TABLE IF NOT EXISTS `vouchers` (
  ...
  `participant_configs` text DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2069 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `voucher_codes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37033 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `voucher_code_configs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4129 DEFAULT CHARSET=utf8mb4;
...
-- Dumping structure for table coupon_yoov_com.voucher_mailing_status
...
CREATE TABLE IF NOT EXISTS `voucher_participants` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3860 DEFAULT CHARSET=utf8mb4;

-- Data exporting was unselected.

-- Dumping structure for table coupon_yoov_com.voucher_smtp_servers
