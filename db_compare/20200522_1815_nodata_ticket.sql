...
-- Dumping structure for table ticket_yoov_com.agent_smtp_servers
...
-- Dumping structure for table ticket_yoov_com.temp_question_forms
...
CREATE TABLE IF NOT EXISTS `vouchers` (
  ...
  `form_sharign_title` varchar(191) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `voucher_codes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35536 DEFAULT CHARSET=utf8mb4;
...
-- Dumping structure for table ticket_yoov_com.voucher_custom_forms
...
-- Dumping structure for table ticket_yoov_com.voucher_medias
...
-- Dumping structure for table ticket_yoov_com.voucher_participants
...
-- Dumping structure for table ticket_yoov_com.voucher_templates
