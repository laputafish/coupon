...
CREATE TABLE IF NOT EXISTS `vouchers` (
  ...
  `entrance_page_typex` enum('questionnaire','custom','none') NOT NULL DEFAULT 'questionnaire',
  `entrance_page_idx` int(10) unsigned DEFAULT '0',
  `entrance_page_type_after_quotax` enum('questionnaire','custom','none') DEFAULT NULL,
  `entrance_page_id_after_quotax` int(10) unsigned DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `voucher_codes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36467 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `voucher_code_configs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4133 DEFAULT CHARSET=utf8mb4;
