...
CREATE TABLE IF NOT EXISTS `vouchers` (
  ...
  `entrance_page_type` enum('questionnaire','custom','none') NOT NULL DEFAULT 'questionnaire',
  `entrance_page_id` int(10) unsigned DEFAULT '0',
  `entrance_page_type_after_quota` enum('questionnaire','custom','none') DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `voucher_codes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36055 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `voucher_code_configs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4117 DEFAULT CHARSET=utf8mb4;
