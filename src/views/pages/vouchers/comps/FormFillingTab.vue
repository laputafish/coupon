    ...
    <div class="row">
      <div class="col-12">
        <div class="mb-1 d-flex flex-row align-items-center">
          <table>
            <tr>
              <td class="font-weight-bold pr-2">No. of Participants</td>
              <td>
                <data-radio-toggle
            ...
            <tr v-if="record.goal_type==='fixed'">
              <td class="font-weight-bold pr-2">Participant Count</td>
              <td>
                <input type="number"
            ...
            <tr v-if="record.goal_type!=='none'">
              <td class="font-weight-bold pr-2">When target archived,</td>
              <td>
                  <data-radio-toggle
            ...
            <tr v-if="record.action_type_after_goal==='custom'">
              ...
              <td>
                  <data-radio-toggle
                      v-if="record.custom_templates.length > 0"
                      :value="record.action_page_after_goal"
                      @input="updateActionTypeAfterGoal"
                      :options="customTemplates"></data-radio-toggle>
  ...
  computed: {
    customTemplates () {
      ...
      for (var i = 0; i < vm.record.custom_templates.length; i++) {
        var template = vm.record.custom_templates[i]
        result.push({
          name: template.name,
