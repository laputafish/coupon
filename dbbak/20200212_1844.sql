...
INSERT INTO `agents` (`id`, `name`, `alias`, `contact`, `tel_no`, `fax_no`, `web_url`, `email`, `remark`, `created_at`, `updated_at`) VALUES
	(1, 'Pacific Coffee', 'PCC', '', '', '', 'https://www.pacificcoffee.com/', '', NULL, NULL, NULL),
...
-- Dumping data for table evoucher.template_keys: ~5 rows (approximately)
DELETE FROM `template_keys`;
/*!40000 ALTER TABLE `template_keys` DISABLE KEYS */;
INSERT INTO `template_keys` (`id`, `key`, `category`, `field_path`, `enabled`) VALUES
	(1, 'agent_name', 'agent', 'agent.name', 1),
	(2, 'agent_web', 'agent', 'agent.web_url', 1),
	(3, 'voucher_expiry_date', 'voucher', 'expiry_date', 1),
	(4, 'voucher_activation_date', 'voucher', 'activation_date', 1),
	(5, 'voucher_description', 'voucher', 'description', 1);
...
INSERT INTO `vouchers` (`id`, `description`, `agent_id`, `activation_date`, `expiry_date`, `template`, `code_fields`, `qr_code_composition`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'aaaaaa', 1, '2020-02-05', '2020-02-19', '<p>sdfsdfdsfdsfsd</p>', NULL, NULL, 'pending', '2020-02-12 07:36:26', '2020-02-12 10:15:59'),
	(2, 'aaaaa', 2, NULL, NULL, NULL, NULL, NULL, 'pending', '2020-02-12 08:05:34', '2020-02-12 08:05:34'),
	(3, 'aaaaa', 3, NULL, NULL, NULL, NULL, NULL, 'pending', '2020-02-12 08:07:45', '2020-02-12 08:07:45');
